    ...
    <>
      <div className="hidden md:flex flex-col justify-between text-2xl text-green-900 border-r-2 shadow-xl px-5 py-10 h-[100vh]">
        <div className="flex flex-col gap-5 w-[36vh]">
          ...
          <div className="flex items-center gap-5">
            <Link
              to="/dashboard/farmer/uploadproduct"
              className=" flex items-center gap-2 px-3 py-1 rounded-xl hover:text-white hover:bg-green-900"
            >
              <RiFolderUploadLine />
      ...
      <div
        className={`fixeed duration-700 ease-in-out flex flex-col justify-between text-2xl text-green-900 border-r-2 shadow-xl px-5 py-10 h-[100vh] ${
      ...
      >
        <div className="flex flex-col gap-5 w-[36vh]">
          ...
          <div className="flex items-center gap-5">
            ...
            >
              <RiFolderUploadLine />
              <button onClick={closeMenu}>Upload </button>
            </Link>
          </div>
          <div className="flex items-center gap-5">
            <Link
            ...
            >
              <MdOutlineAddShoppingCart />
              <button onClick={closeMenu}>Received O</button>
            </Link>
          </div>
          <div className="flex items-center gap-5">
            <Link
            ...
            >
              <PiPlantFill />
              <button onClick={closeMenu}>Stock</button>
            </Link>
          </div>
          <div className="flex items-center gap-5">
            <Link
